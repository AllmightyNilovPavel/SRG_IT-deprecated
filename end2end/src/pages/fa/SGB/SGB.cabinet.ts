class SGBUserCabinet {
  ...
  get $OrderList_tableContent() {
    return this.$root_OrderList.$(
      "//table[@class='ui collapsing selectable striped compact table']"
    );
  }
...
export const sgbUserCabinet = new SGBUserCabinet();
