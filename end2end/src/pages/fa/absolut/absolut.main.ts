...
export class AbsolutOcenka {
  path = `ocenka-absolutbank.srg-test.ru`;
  ...
  open() {
    browser.url(FaHostNameResolver(SiteList.ABSOLUT));
  }
...
/** Сайт Абсолют Банк */
export const absolutOcenka = new AbsolutOcenka();
