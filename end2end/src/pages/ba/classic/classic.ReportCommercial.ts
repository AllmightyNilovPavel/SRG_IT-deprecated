import { CommercialObjectType, ActionButtons } from "./enums";
import { ICommercialReport } from "options/testData/ba";

class ReportCommercial {
  ...
  // --------------------------------------------------
  /** Тип объекта оценки */
  private get $selector_commercialObjectType() {
    return this.$report_body.$(`#appraisalObjectType`);
  }
  /** Содержание объекта оценки */
  private get $selector_commercialObjectContent() {
  ...
  //                                Функции
  // ---------------------------------------------------------------------------
  actionWithReport(action: ActionButtons) {
  ...
  selectCommercialObject(object: CommercialObjectType) {
    this.$selector_commercialObjectType.selectByAttribute("value", object);
  }
  ...
  fillCommercialObjectData(data: ICommercialReport) {
    ...
    this.$selector_commercialObjectType.selectByIndex(fields.commercialObjectType_index);
    this.$selector_commercialObjectContent.selectByIndex(fields.commercialObjectContent_index);
...
export const reportCommercial = new ReportCommercial();
