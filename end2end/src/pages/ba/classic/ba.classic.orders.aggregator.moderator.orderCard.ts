class BaAggregatorModeratorOrderOrderCard {
  path = "/fa_aggregator_valuation_order.html";
...
export const baAggregatorModeratorOrdersCard = new BaAggregatorModeratorOrderOrderCard();
