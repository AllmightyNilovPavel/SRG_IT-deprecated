...
describe(`FA. ПСБ. End2end. Военная ипотека. `, function () {
  ...
  it(`Выбор типа Кредитования`, function () {
    ...
    let errorMsgMilitaryMortgage :string = 'Кнопка Военная ипотека недоступна или не кликабельна'
    let errorMsgMilitaryNewCredit :string = 'Кнопка Новый кредит для военной ипотеки недоступна или не кликабельна'
    ...
    psbOcenka.$MilitaryMortgage.waitForClickable();
     expect(psbOcenka.$MilitaryMortgage.isClickable(),errorMsgMilitaryMortgage).to.be.true;
    psbOcenka.$MilitaryMortgage.click();
    psbOcenka.$MilitaryNewCredit.waitForClickable();
     expect(psbOcenka.$MilitaryNewCredit.isClickable(),errorMsgMilitaryNewCredit).to.be.true;
     makeScreenshot("выбор_типа_кредитования");
    psbOcenka.$MilitaryNewCredit.click();
