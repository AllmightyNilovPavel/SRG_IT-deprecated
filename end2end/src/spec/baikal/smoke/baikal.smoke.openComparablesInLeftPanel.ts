...
let testName: string = `Байкал. Открытие раздела "Аналоги" из левой панели Байкала`;
...
describe.skip(testName, function () {
  ...
  it(`Проверить, что при нажатии на раздел "Аналоги" из левой панели Байкала - раздел "Аналоги" откроется`, function () {
    allureReporter.generateReport();
    expect(
