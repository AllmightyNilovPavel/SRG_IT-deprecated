...
describe(`КРОНА. ВТБ. БЗО-Недвижимость. Маршрутка. Первая версия отчёта. Ручник SRG. 10% < Отклонение SRG от цены отчёта < 30%. Возврат на доработку.`, function () {
  ...
  it(`Проверка статуса заказа.`, function () {
    ...
    expect(orderStatus, errorMsg).to.be.equal("На доработке");
