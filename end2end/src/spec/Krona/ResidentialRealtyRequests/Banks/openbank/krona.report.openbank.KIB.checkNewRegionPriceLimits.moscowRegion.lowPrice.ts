...
describe(`КРОНА. ОТЧЁТ. ОТКРЫТИЕ. КИБ. Новые условия проверки дорогих объектов. Московская область. Ниже лимита.`, function () {
  let requestId: string = "";
  const TestData = KronaTestDataOpenbankReportsOverprice.FLAT.MOSCOW_REGION.LOW_PRICE;
