...
describe(`КРОНА. ОТКРЫТИЕ. МСБ. Новые условия проверки дорогих объектов. Ямало-Ненецкий регион. Ниже лимита.`, function () {
  let requestId: string = "";
  const TestData = KronaTestDataOpenbankRequestsOverprice.FLAT.YAMALO_NENETS.LOW_PRICE;
  ...
  it(`Оцениваем запрос`, function () {
    ...
    for (let i = 1; i < 4; i++) {
      kronaExpertRequestCard
        ...
        .setValue(TestData.price - 4000000);
      kronaExpertRequestCard
