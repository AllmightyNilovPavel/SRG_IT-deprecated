...
describe(`КРОНА. ОТКРЫТИЕ. МСБ. Новые условия проверки дорогих объектов. Московская область. Выше лимита.`, function () {
  let requestId: string = "";
  const TestData = KronaTestDataOpenbankRequestsOverprice.FLAT.MOSCOW_REGION.HIGH_PRICE;
  ...
  it(`Заполнить форму`, function () {
    ...
    requestsCreateApartment.FullfillApartmentRequest(TestData);
  });
  ...
  it(`Оцениваем запрос`, function () {
    ...
    kronaExpertRequestCard.fillDataFromAnotherRequest("278862");
