...
describe(`КРОНА. ОТЧЁТ. ОТКРЫТИЕ. КИБ. Новые условия проверки дорогих объектов. Московская область. Больше лимита.`, function () {
  let requestId: string = "";
  const TestData = KronaTestDataOpenbankReportsOverprice.FLAT.MOSCOW_REGION.HIGH_PRICE;
  ...
  //   kronaFiltersBox.inputCustomField(TestData.FLAT.MOSCOW.HIGH_PRICE.custom1, 1);
