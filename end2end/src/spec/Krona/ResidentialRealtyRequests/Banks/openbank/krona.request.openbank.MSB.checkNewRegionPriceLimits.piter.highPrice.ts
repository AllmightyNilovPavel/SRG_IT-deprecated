...
describe(`КРОНА. ОТКРЫТИЕ. МСБ. Новые условия проверки дорогих объектов. Питер. Больше лимита.`, function () {
  let requestId: string = "";
  const TestData = KronaTestDataOpenbankRequestsOverprice.FLAT.PITER.HIGH_PRICE;
