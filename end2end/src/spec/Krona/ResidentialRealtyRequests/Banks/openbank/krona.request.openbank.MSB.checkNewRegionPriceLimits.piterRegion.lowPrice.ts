...
describe(`КРОНА. ОТКРЫТИЕ. МСБ. Новые условия проверки дорогих объектов. Ленинградская область. Ниже лимита.`, function () {
  let requestId: string = "";
  const TestData = KronaTestDataOpenbankRequestsOverprice.FLAT.PITER_REGION.LOW_PRICE;
