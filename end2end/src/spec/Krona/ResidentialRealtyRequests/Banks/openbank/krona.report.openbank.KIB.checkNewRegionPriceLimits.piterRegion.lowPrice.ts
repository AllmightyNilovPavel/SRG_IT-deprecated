...
import { TestDataKrona } from "options/testData";

describe(`КРОНА. ОТЧЁТ. ОТКРЫТИЕ. КИБ. Новые условия проверки дорогих объектов. Ленинградская область. Ниже лимита.`, function () {
  let requestId: string = "";
  let TestData = KronaTestDataOpenbankReportsOverprice.FLAT.PITER_REGION.LOW_PRICE;
