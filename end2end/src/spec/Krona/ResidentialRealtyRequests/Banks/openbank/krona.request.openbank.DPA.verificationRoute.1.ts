...
// Скипаем потому что сложно попадать каждый раз в цену робота
// без предварительного MOCK'a базы или ответа робота.
describe.skip(`КРОНА. ОТКРЫТИЕ. Маршрутка. ДПА. Кейс №1.`, function () {
