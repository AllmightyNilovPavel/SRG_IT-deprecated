...
describe(`КРОНА. SELHOZ. ДРПА. Реестр объектов. ЗЕМЕЛЬНЫЙ УЧАСТОК. Новый запрос на оценку.`, function () {
  ...
  it(`Заполнить форму`, function () {
    ...
    kronaSelhozRequestsCreation.fullfillSelhozRequest(RealtyType.LAND, KronaTestDataSelhoz.REQUEST);
    this.retries(3);
  });
