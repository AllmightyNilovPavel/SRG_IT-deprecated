...
describe(`BA. CLASSIC. SMOKE. Реестр отчётов. Движимое имущество.`, function () {
  ...
  it(`Перейти на вкладку "Движимое имущество"`, function () {
    allureReporter.generateReport();
    baClassicNavMenu.navigateTo(BaNavigationButtons.MOVABLE);
    baClassicReportsTable.waitForLoad();
    expect(browser.getUrl()).to.include("/movable");
  });
